...
namespace MatchFixer.Infrastructure.Migrations
{
    ...
    [Migration("20260801173603_AddPrePostponeStatusToMatchEvent")]
    partial class AddPrePostponeStatusToMatchEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.BetSlip", b =>
                {
                    ...
                    b.Property<DateTime?>("SettledAt")
                        .HasColumnType("datetime2")
                        .HasComment("UTC timestamp when the bet slip was settled (Won, Lost, or Voided)");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.LiveMatchResult", b =>
                {
                    ...
                    b.Property<bool?>("HomeWonOnPenalties")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.MatchEvent", b =>
                {
                    ...
                    b.Property<bool>("NoDraw")
                        .HasColumnType("bit");

                    b.Property<int?>("PrePostponeStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.MatchEventLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.OddsBoost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("BoostValue")
                        .HasPrecision(5, 2)
                    ...
                    b.Property<decimal?>("MaxStakePerBet")
                        .HasPrecision(18, 2)
                    ...
                    b.HasIndex("MatchEventId", "IsActive", "StartUtc", "EndUtc");

                    b.HasIndex("MatchEventId", "StartUtc", "EndUtc", "IsActive");

                    b.ToTable("OddsBoosts");
                });
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.Team", b =>
                {
                    ...
                    b.Property<string>("LocalLogoUrl")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<DateTime?>("LogoLastSyncedUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.TeamAlias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.Trophy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsHiddenUntilEarned")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.UpcomingMatchEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.UserTrophy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime?>("HistoryClearedFromAdminAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ReasonForLock")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.WorldCupGroupStanding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorldCupGroupStandings");
                });
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.Bet", b =>
                {
                    ...
                    b.HasOne("MatchFixer.Infrastructure.Entities.OddsBoost", "OddsBoost")
                        .WithMany()
                        .HasForeignKey("OddsBoostId");

                    b.Navigation("BetSlip");

                    b.Navigation("MatchEvent");

                    b.Navigation("OddsBoost");
                });
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.MatchEventLog", b =>
                {
                    b.HasOne("MatchFixer.Infrastructure.Entities.ApplicationUser", "ChangedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.TeamWikiInfo", b =>
                {
                    b.HasOne("MatchFixer.Infrastructure.Entities.Team", "Team")
                        .WithOne("WikiInfo")
                        .HasForeignKey("MatchFixer.Infrastructure.Entities.TeamWikiInfo", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MatchFixer.Infrastructure.Entities.UserTrophy", b =>
                {
                    b.HasOne("MatchFixer.Infrastructure.Entities.Trophy", "Trophy")
