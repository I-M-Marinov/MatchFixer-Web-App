namespace MatchFixer.Common.GeneralConstants
{
	public static class OddsBoostConstants
	{
		...
		public const string MatchEventNotFound = "Match event not found.";
		public const string OverlappingBoostExists = "An active boost already overlaps with this timeframe.";
		public const string BoostNotFound = "Odds boost not found.";
	}
}
